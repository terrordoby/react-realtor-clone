  ...
  return (
    <section className="max-w-6xl mx-auto flex justify-center items-center flex-col">
      ...
      <div className="w-full md:w-[50%] mt-6 px-3">
        ...
        <button
          type="submit"
          className="bg-blue-600 uppercase px-7 py-3 text-sm text-white font-medium w-full hover:bg-blue-700
            transition duration-200 ease-in-out rounded shadow-sm">
